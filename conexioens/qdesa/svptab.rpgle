      ...
      * JSN 10/06/2025 - Se depreca los procedimientos:              *
      *                  _getSet103                                  *
      *                  _getSet103s                                 *
      *                  Se agrega el procedimiento:                 *
      *                  _getSet103V2                                *
      *                  Se modifico la tabla set103 para agregar el *
      *                  campo TPSC, SubCategoria de texto, pertenece*
      *                  al JIRA DESA-721.                           *
      ...
      * "DEPRECATED" Se debe utilizar SVPTAB_getSet103s().           *
      *                                                              *
      *     peRama   (input)   Rama                                  *
      *     peXpro   (input)   Producto                              *
      *     peRiec   (input)   Riesgo                                *
      ...
      * "DEPRECATED" Se debe utilizar SVPTAB_getSet103V2().          *
      *                                                              *
      *     peRama   (input)   Rama                                  *
      *     peXpro   (input)   Producto                              *
      *     peRiec   (input)   Riesgo                                *
      ...
      * ------------------------------------------------------------ *
      * SVPTAB_getSet103V2(): Retorna SET103                          *
      *                                                              *
      *     peRama   (input)   Rama                                  *
      *     peXpro   (input)   Producto                              *
      *     peRiec   (input)   Riesgo                                *
     ...
     P SVPTAB_getSet103V2...
     P                 B                   export
     D SVPTAB_getSet103V2...
     D                 pi              n
     D   peRama                       2  0 const
     D   peXpro                       3  0 const
     D   peRiec                       3    const
