     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_nuevoObjetoLista: Abre un nuevo objeto SVPJSON       *
      *                                                              *
      * ------------------------------------------------------------ *
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_cerrarObjLista: Cierra un objeto SVPJSON             *
      * ------------------------------------------------------------ *
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_objetosArray: Arma json segun tablas                 *
      *                                                              *
      * ------------------------------------------------------------ *
     ...
     D  pxCampo                   32767
      /free
         ...
         dow not %eof(pawpec);
            ...
            reade %kds(k1wpec:2) pawpec;
         enddo;
         pxCampo = %trim(auxJson);
         return *on;
      /end-free
     P SVPJSON_objetosArray...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_objetosArrayAnidados: Arma json segun tablas         *
      *                                                              *
      * ------------------------------------------------------------ *
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_objetosLista: Cierra un objeto SVPJSON               *
      * ------------------------------------------------------------ *
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_cargaProp: Cargo las propiedades                     *
      *                                                              *
      * ------------------------------------------------------------ *
     P SVPJSON_cargaProp...
     P                 b                   export
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPJSON_setTipoDato: Segun el tipo de propiedad hago una cosa*
      *                      u otra                                  *
      * ------------------------------------------------------------ *
