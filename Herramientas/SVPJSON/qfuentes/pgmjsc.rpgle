     ...
     * - ----------------------------------------------------------- *
        dcl-f sinensup usage(*input) keyed;
        dcl-f gntpec   usage(*input) keyed;
        dcl-f pawpec   usage(*input) keyed;
        dcl-f gntpca   usage(*input) keyed;
     * - ----------------------------------------------------------- *
     *   Copys
     * - ----------------------------------------------------------- *
     ...
     * - ----------------------------------------------------------- *
        ...
        dcl-s jsons  char(20) inz('JSONCONTADURIA');
     * - ----------------------------------------------------------- *
     * Datos de cuenta
     * - ----------------------------------------------------------- *
     ...
     * - ----------------------------------------------------------- *
        /free
            *inlr = *on;
            ...
            objetoCuentas();
            //objetos de tabla
            SVPJSON_objetosArray( uds.usempr
                                : uds.ussucu
                                : jsons
                                : auxJson);
