      ...
      * IMF 19/08/25 - Agrego SVPSIN_getFechaSiniestro para obtener  *
      *                la fecha de un siniestro. DESA-859            *
      * ************************************************************ *
     ...
     P                 e
      * ------------------------------------------------------------ *
      * SVPSIN_getFechaSiniestro(): Get de la fecha de un siniestro  *
      *                                                              *
      *     peEmpr   (input)   Empresa                               *
      *     peSucu   (input)   Sucursal                              *
      *     peRama   (input)   Rama                                  *
      *     peNops   (input)   Operacion de Siniestro                *
      *     pxFsid   (output)  Fecha siniestro dia                   *
      *     pxFsim   (output)  Fecha siniestro mes                   *
      *     pxFsia   (output)  Fecha siniestro anio                  *
      * Retorna: *On Encontro siniestro / *Off NO encontro siniestro *
      * ------------------------------------------------------------ *
     P SVPSIN_getFechaSiniestro...
     P                 B                   export
     D SVPSIN_getFechaSiniestro...
     D                 pi              n
     D   peEmpr                       1    const
     D   peSucu                       2    const
     D   peRama                       2  0 const
